...
export default function Skull(props: any) {
  ...
  const changeImage = () => {
    setImageSource(require("../assets/img/pngwing.com.png")); // Cambiar la imagen momentáneamente
    setTimeout(() => {
      setImageSource(require("../assets/img/calavera2.png")); // Volver a la imagen original después de 1 segundo
    }, 1000);
  };
